...
defined('PX') ? NULL : define('PX', 'auto24_');
...
defined('ROOT_URL') ? null : define('ROOT_URL', 'http://ubuntu.ametikool.ee/~TAK15_Lohmus/start/AUTO24_Lauri_Andero/');
defined('ROOT_PATH') ? null : define('ROOT_PATH', DS .'home'.DS.'TAK15_Lohmus'.DS.'public_html'.DS.'start'.DS.'AUTO24_Lauri_Andero'.DS);
